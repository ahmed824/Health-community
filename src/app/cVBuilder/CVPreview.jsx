...
const CVPreview = ({
  ...
  >
    {/* Header */}
    <header className="flex flex-col sm:flex-row items-start sm:items-center mb-4 pb-2 border-b-2 gap-4 border-[#323332]">
      {/* Profile Photo */}
                  ...
                  <p className="text-sm font-semibold text-[#323332]">
                    ...
                    {(exp.country || exp.city) && (
                      <span className="ml-2 text-xs font-normal text-[#323332]">
                        ...
                        {exp.country && exp.city ? ", " : ""}
                        {exp.city &&
                          exp.city.charAt(0).toUpperCase() + exp.city.slice(1)}
                      </span>
                    )}
                  </p>
                </div>
                  ...
                  <p className="text-sm font-semibold text-[#323332]">
                    ...
                    {(edu.country || edu.city) && (
                      <span className="ml-2 text-xs font-normal text-[#323332]">
                        ...
                        {edu.country && edu.city ? ", " : ""}
                        {edu.city &&
                          edu.city.charAt(0).toUpperCase() + edu.city.slice(1)}
                      </span>
                    )}
                  </p>
                </div>
